...
//get all todos
router.get('/viewTodo', checkAuth, (req, res,next) => {
    Todo.find()
    .populate('todo_Jobsite')
    .populate('todo_createdBy_user')
    .populate('todo_createdBy_admin')
    .populate('todo_assignedTo_user')
    .populate('todo_assignedTo_admin')
    .populate('todo_cc_user')
    .populate('todo_cc_admin')
    .exec()
    .then(result => {
        if(result.length > 0) {
...
//delete todo
router.delete('/deleteTodo/:todoId', checkAuth, (req, res,next) => {
    const id = req.params.todoId;
